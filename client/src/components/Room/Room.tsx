        ...
        <View>
            <View style={{flexDirection:"row", marginBottom: 16}}>
                <View style={[styles.roomContainer, {marginRight: 16}]}>
                    ...
                    <ModalDropdown defaultValue={"Empty"} options={["Empty", 'Assistant In', 'Assistant Required', 'Doctor In', 'Doctor Required', 'Patient in', 'Financial In', 'Financial Required', 'Emergency']}/>
                    </View>                        
                </View>                
